...
WebUI.click(findTestObject('Page_OrangeHRM/i_Dashboard_oxd-icon bi-caret-down-fill oxd-userdropdown-icon'))

WebUI.click(findTestObject('Page_OrangeHRM/a_Logout'))

WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/h5_Login'), 0)
